...
<div id="wssf_notice_box">
  <p class="notice_p">Use this shortcode to display your social feed : <span id='shortcode'>[Twitterfeed id='<?php echo $CPostId; ?>']</span></p>
</div>
  <div class='wrap'> 
  ...
  <ul class="tabs">
    <li class="tab-link current" data-tab="tab-2"><img src='<?php echo plugins_url( '/images/twitter.png', __FILE__); ?>' /></li>
  </ul>
  ...
  <div id="tab-2" class="tab-content current">
     ...
     <div class="accordion-section">
        ...
        <td><label for="wssf_feed_width">
          ...
          <p class="description"><?php _e( 'Set the container width for the feed   <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b> '); ?></p>
          </label>
        </td>
      </tr>
          ...
          <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                    ...
                    <p class="description"><?php _e( 'Hide text content of the feed <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b>'); ?></p>
           </td>
          </tr>
          ...
          <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                    ...
                    <p class="description"><?php _e('Show hide links to post in feed <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b>'); ?></p>
          ...
          <tr valign='top'>
            ...
            <td>
              ...
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Default  <input type="radio" name="wssf_select_layout" id="layout"  value="layout" checked="checked" /></p> 
              ...
              <div  style="float:left;">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 1--<a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b> <input  disabled type="radio" id="layout1" <?php  checked('layout1', get_post_meta($post->ID,'wssf_select_layout',true)); true ?> /></p>
              ...
              <div  style="float:left;">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 2--<a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b> <input  disabled type="radio" name="" id="layout2"  <?php  checked('layout2', get_post_meta($post->ID,'wssf_select_layout',true)); true ?> /></p>
              ...
              <div  style="float:left;">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 3-- <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b> <input  disabled type="radio" name="" id="layout3" <?php  checked('layout3', get_post_meta($post->ID,'wssf_select_layout',true)); true ?> /></p>
              ...
              <br>
                ...
                <div  style="float:left;">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 4-- <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b> <input  disabled type="radio" name="" id="layout3" <?php  checked('layout3', get_post_meta($post->ID,'wssf_select_layout',true)); true ?> /></p>
...
<div class="accordion-section">
        ...
        <td><label for="wssf_bg_color">
          ...
          <p class="description"><?php _e( 'Select Background Color for feed <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b>'); ?></p>
          </label>
        </td>
      </tr>
...
<tr valign="top">
        ...
        <td><label for="wssf_text_color">
          ...
          <p class="description"><?php _e( 'Select Text Color for feed <a href="http://web-settler.com/wordpress-facebook-feed/?ref=twitterFeed">Buy Premium Version</a> </b>'); ?></p>
          </label>
        </td>
      </tr>
      ...
      <tr valign="top">
        ...
        <td><label for="wssf_select_gfont">
          ...
          <p class="description"><?php _e( 'Change font for the feeds <a href="http://web-settler.com/wordpress-facebook-feed/ref=twitterFeed">Buy Premium Version</a> </b>'); ?></p>
